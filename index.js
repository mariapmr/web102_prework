...
const totalContributions = GAMES_JSON.reduce((total, game) => total + game.pledged, 0);
...
const displayString = `A total of $${totalContributions.toLocaleString('en-US')} has been raised for ${numGames.toLocaleString('en-US')} games. Currently, ${unfundedCount} game${unfundedCount !== 1 ? 's' : ''}  remain${unfundedCount !== 1 ? '' : 's'} unfunded. We need your help to fund these amazing games! `;

// create a new DOM element containing the template string and append it to the description container
const statsElement = document.createElement('p');

statsElement.textContent = displayString;
